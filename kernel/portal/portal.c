...
static const lyric_t still_alive_lyrics[] = {
    ...
    { 26, "my ", 60 },
    { 27, "satisfaction.\n", 120 },
    { 0xFFFFFFFF, 0 }  /* sentinel — keep last */
};
...
static void draw_chrome(void) {
    clear_screen();
    kprint_at("  == APERTURE SCIENCE ==  ", 19, 0);
...
/* Write one character into the lyric box, with wrap + scroll. */
 ...
 * between them (pseudo-polyphony) — otherwise the active voice plays
 * cleanly. Lyrics type out underneath on their own cadence.
 */
