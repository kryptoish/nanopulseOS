...
const lyric_t still_alive_lyrics[] = {
    { 0, "\n" },
...
/* --- ASCII-art frames shown in the right-hand panel. --- */

static const char art_empty[] =
    "\n"
    "\n"
    "\n"
    "\n"
...
static const char art_radiation[] =
    "             =+$HM####@H%;,\n"
    "          /H###############M$,\n"
    "          ,@################+\n"
    "           .H##############+\n"
...
static const char art_checkmark[] =
    "                                     :X-\n"
    "                                  :X###\n"
    "                                ;@####@\n"
    "                              ;M######X\n"
...
static const char art_explosion[] =
    "            .+\n"
    "             /M;\n"
    "              H#@:              ;,\n"
    "              -###H-          -@/\n"
...
static const char art_black_mesa[] =
    "           .-;+$XHHHHHHX$+;-.\n"
    "        ,;X@@X%/;=----=:/%X@@X/,\n"
    "      =$@@%=.              .=+H@X:\n"
    "    -XMX:                      =XMX=\n"
...
const art_frame_t still_alive_frames[] = {
    { 0,   art_empty },
    { 32,  art_aperture },
    { 60,  art_radiation    },
    { 68,  art_aperture },
